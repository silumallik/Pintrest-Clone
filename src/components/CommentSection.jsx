...
// export default function CommentSection({ pinId, comments }) {
...
//       {/* INPUT */}
//       <div className="flex gap-2 mb-4" style={{ marginRight: "1%" }}>
...
//         <div key={comment._id} className="flex items-start gap-3 mb-3" style={{ margin: ".8rem 0px" }}>
